...
def answer_question(
    ...
    try:
        ...
        response = openai.ChatCompletion.create(
            messages=[{"role":"assistant","content":f"Answer the question in {language} based on the context below,\nContext: {context}\n\n---\n\nQuestion: {question}\nAnswer:"}],
            temperature=0,
...
print("Answer: "+answer_question(df,question="কোনারক মন্দিরের ইতিহাস কি?"))
